...
export default async function Shows() {
  ...
  return (
    <div id="Shows" className="justify-start p-12 h-fit overflow-hidden">
      <div className="text-center justify-center">
        <h1 className="text-white text-7xl md:text-8xl font-normal font-['Bakbak_One'] tracking-widest">
          SHOWS
        </h1>
      </div>
          ...
          <div key={show._id} className="flex flex-col">
            <div className="flex flex-col md:flex-row items-start justify-between py-5">
              ...
              <div className="h-10 px-5 bg-red-700 rounded-lg inline-flex justify-center items-center hover:bg-white">
                <a
                  className="text-white text-2xl uppercase tracking-[2px] font-asap hover:text-red-700"
                  href={show.buyLink}
                >
                  Tickets
                </a>
